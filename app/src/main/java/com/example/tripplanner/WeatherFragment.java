...
public class WeatherFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        btnRetry = view.findViewById(R.id.btnRetryWeather);
    ...
    void fetchLocationThenWeather() {
        ...
        try {
            // Strip "Chennai, Tamil Nadu, India" → "Chennai" for geocoding
            ...
            httpClient.newCall(request).enqueue(new Callback() {
                ...
                public void onFailure(@NonNull Call call, @NonNull IOException e) {
                    mainHandler.post(() -> {
                        tvLoading.setText("⚠️ Connection error.");
                ...
                public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                    if (!response.isSuccessful()) {
                        mainHandler.post(() -> {
                            tvLoading.setText("⚠️ City not found.");
                            btnRetry.setVisibility(View.VISIBLE);
                        });
                        return;
                    }
                    ...
                    try {
                        ...
                        mainHandler.post(() -> {
                            tvLoading.setText("⚠️ Error finding location.");
                            btnRetry.setVisibility(View.VISIBLE);
                        });
                    }
                }
    ...
    void fetchOpenMeteoWeather(double lat, double lon) {
        ...
        httpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NonNull Call call, @NonNull IOException e) {
                mainHandler.post(() -> {
                    tvLoading.setText("⚠️ Weather service unavailable.");
                    btnRetry.setVisibility(View.VISIBLE);
                });
            }
            ...
            public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                if (!response.isSuccessful()) {
                    mainHandler.post(() -> {
                        tvLoading.setText("⚠️ Weather data error.");
                        btnRetry.setVisibility(View.VISIBLE);
                    });
                    return;
                }
