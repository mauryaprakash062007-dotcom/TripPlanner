...
public class PackListFragment extends Fragment {
    ...
    void buildPackList(boolean willRain, boolean willBeHot, boolean willBeCold, boolean highWind) {
        ...
        for (String activity : activities) {
            ...
            if (act.contains("beach") || act.equals("beach")) {
            ...
            } else if (act.contains("hike") || act.contains("trek") || act.equals("hiking")) {
                if (!isMountainDest) {
            ...
            } else if (act.contains("shop") || act.equals("shopping")) {
            ...
            } else if (act.contains("sight") || act.equals("sightseeing")) {
            ...
            } else if (act.contains("food") || act.contains("restaurant") || act.contains("cafe") || act.contains("eat") || act.equals("food")) {
            ...
            } else if (act.contains("camp") || act.equals("camping")) {
            ...
            } else if (act.contains("adventure") || act.contains("sport") || act.equals("adventure")) {
